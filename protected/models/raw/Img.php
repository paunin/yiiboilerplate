...
class Img
{
    ...
    public static function getSizedPath($path, $max_w, $max_h, $web = true, $need_crop = false, $crop_top = 'top', $crop_left = 'center',$new_path = null, $remove_orig = false)
    {
    ...
    private static function getCachePathForImg($path)
    {
        ...
        $path_info = pathinfo($path);
        return $cache_root . self::makeRelativePath($path_info['dirname']) . '/' . $path_info['basename'] . '/';
    }
