...
class RecoveryPassForm extends User
{
    ...
    public function recovery()
	{
        ...
        return myMail::send($user->email,Yii::t('c_app','Recovery password'),'recovery_pass',array('url'=>Cut::createUrl('user/register/endrecoverypass',array('key'=>$user->key),true)));
	}
}
